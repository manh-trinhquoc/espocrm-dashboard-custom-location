define('dashboard-custom-location:views/record/list', ['views/main', 'search-manager'],
    function (Dep, SearchManager) {
        ...
        return Dep.extend({
             ...
             * @inheritDoc
             */
            template: 'dashboard-custom-location:record/list',
             ...
             * @type {string}
             */
            dashboardView: 'dashboard-custom-location:views/dashboard',
            ...
            setup: function () {
                ...
                this.dashboardView = this.options.dashboardView || this.dashboardView;
             ...
             * Set up a dashbard.
             */
            setupDashbard: function () {
                this.createView('dashboard', this.dashboardView, {
                    el: '#main > .page-dashboard',
                    scope: this.scope,
                });
            },
