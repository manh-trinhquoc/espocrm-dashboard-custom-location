...
```
vendor/bin/phpunit tests/unit/Espo/Modules/VietnameseTranslation
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/VietnameseTranslation
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/VietnameseTranslation`
* `site/tests/integration/Espo/Modules/VietnameseTranslation`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/VietnameseTranslation/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/VietnameseTranslation/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/vietnamese-translation/lib/init.js"
        ]
    }
    ```
